...
} from "./chunk-WQSV4ACC.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-JSARQNJZ.js";
import {
...
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-3PFF7RA7.js";
import {
  require_pick
} from "./chunk-VPKOTKHC.js";
import {
  useEnterprise
} from "./chunk-67QNRNK4.js";
import {
  Login
} from "./chunk-3JWPZ2ZJ.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-KYPWJ5IN.js";
import {
  ConfigurationProvider
} from "./chunk-MDARSEJJ.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-2XEBX73J.js";
import {
  require_baseRest
} from "./chunk-5EVL2P2R.js";
import {
  HistoryProvider
} from "./chunk-LQDR45SB.js";
import {
  errorsTrads
...
import {
  TrackingProvider,
  useTracking
} from "./chunk-G7EJZVIY.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-QWLQ3BMP.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-EWXSBLXZ.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-6JJBJCON.js";
import {
  MemoizedInputRenderer
} from "./chunk-KPF4FCIN.js";
import {
  Form
} from "./chunk-O5QWAGLK.js";
import {
  Layouts
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-V4JO4ILD.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-JZ3PZ62V.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-7ESPXK7D.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-AOW6WYET.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-EJHTGP7R.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-6CLZFLPL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-E4MN4MDH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-45P5PMYO.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-JDPVHPPF.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-NQYBGI76.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-DDH7DCGM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GJKHSQW5.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RSLLTLL7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-3XZB4US7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-JOMKZAG7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ND6YHCFQ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ONDMGKE2.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-J3L5FHBJ.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-TAYIXTFY.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-PKQD5NTM.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-K5Q4YMAO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-WYCWUV4T.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-DMYPHPCO.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-PXTOYALU.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-BV6CWRIX.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-GSQSBCYH.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-IXYOR66C.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-DWVLILXW.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-BBXL3LJP.js");
              return {
...
//# sourceMappingURL=chunk-SIPXORS5.js.map
