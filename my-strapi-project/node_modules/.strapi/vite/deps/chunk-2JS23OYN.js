...
} from "./chunk-HCDCEH35.js";
import {
  useTypedSelector
} from "./chunk-L3ZX5SAX.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-KQUDOWG3.js";
import {
  useConfig
} from "./chunk-BM4KMYBS.js";
import {
  AssetSource,
  AssetType,
  ...
  pluginPkg,
  viewOptions
} from "./chunk-VDDGIYNJ.js";
import {
  PERMISSIONS as PERMISSIONS2
} from "./chunk-PDGPTUUZ.js";
import {
  useDocumentActions
} from "./chunk-EJSTJGDV.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-V42F7GHI.js";
import {
  PERMISSIONS,
  reducer,
  reducer2
} from "./chunk-JD26MILH.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  renderAdmin
} from "./chunk-SIPXORS5.js";
import {
  useLicenseLimits
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-MJZLKNB2.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-AGMV5IHQ.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-BF6R7MXK.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-SNYVHU5R.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-QPVNSXZH.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-MHBYPOLN.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-ZAMOFKIX.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-DKHIGW76.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-F7P2GCOD.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-P7D3GVRJ.js");
          return {
...
//# sourceMappingURL=chunk-2JS23OYN.js.map
