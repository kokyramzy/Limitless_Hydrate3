...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-FQI6SSDE.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-WF67UDAK.js").then((mod) => ({
...
//# sourceMappingURL=router-F7P2GCOD.js.map
